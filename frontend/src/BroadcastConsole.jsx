                  ...
                  <div style={{ flex: 1, padding: '14px 14px 10px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    ...
                    <Suspense fallback={
                      ...
                      <AdvancedMetrics
                        ...
                        calculatePlayerMetrics={calculatePlayerMetrics}
                    ...
                    <Suspense fallback={
                      <div style={{ 
                        ...
                        🎯 Loading Player Development...
                      </div>
                    }>
                      <PlayerDevelopment
                        processedRoster={processedRoster}
                        calculatePlayerMetrics={calculatePlayerMetrics}
                        showPlayerDevelopment={showPlayerDevelopment}
                        setShowPlayerDevelopment={setShowPlayerDevelopment}
                      />
                    </Suspense>
